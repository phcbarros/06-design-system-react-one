...
type ButtonProps = ComponentProps$1<typeof Button>;
...
interface TextInputProps extends ComponentProps<typeof Input>, React.InputHTMLAttributes<HTMLInputElement> {
    prefix?: string;
}
declare function TextInput({ prefix, ...props }: Readonly<TextInputProps>): react_jsx_runtime.JSX.Element;
